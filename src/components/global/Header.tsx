...
import { Globe, Heart, Menu, X, User, LogOut, Loader2 } from "lucide-react";
...
export default function Header() {
  ...
  const inventoryFilters = ["GT500", "GT350", "GT350R", "Super Snake", "Cobra Jet", "Classic Shelby", "Performance Trucks"];
  ...
  return (
    <>
      ...
      <div className="bg-[#f3f4f6]/30 py-2 px-5 md:px-8 border-b border-[#dee1e6]">
        <div className="max-w-[1440px] mx-auto flex justify-end items-center gap-4 text-[11px] font-medium text-[#565d6d]">
