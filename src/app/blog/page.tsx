  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[1440px] mx-auto px-4 md:px-12 py-12">
        <div className="mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-outfit font-black tracking-tighter mb-4 break-words">Articles</h1>
        ...
        {featuredArticle ? (
          <Link href={`/blog/${featuredArticle.slug || featuredArticle.id}`} className="relative rounded-3xl overflow-hidden mb-16 group cursor-pointer block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {gridArticles.map((article) => (
            <Link href={`/blog/${article.slug || article.id}`} key={article.id} className="bg-white rounded-2xl border border-[#dee1e6] overflow-hidden card-shadow group cursor-pointer block">
